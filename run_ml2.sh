...
class1_args="epochs=100, outdir='dev3/5_encoderclass-resnet_1-pretrained-frozen', device='cuda:0', autoencoder_dir='dev2/5_autoencoder-resnet', freeze=True, label='1. Pretrained, frozen encoder'"

# 2. Train classifier with pretrained, unfrozen encoder
class2_args="epochs=100, outdir='dev3/5_encoderclass-resnet_2-pretrained-unfrozen', device='cuda:1', autoencoder_dir='dev2/5_autoencoder-resnet', freeze=False, label='2. Pretrained, unfrozen encoder'"

# 3. Train classifier with untrained, frozen encoder
class3_args="epochs=100, outdir='dev3/5_encoderclass-resnet_3-untrained-frozen', device='cuda:0', autoencoder_dir=None, freeze=True, label='3. Untrained, frozen encoder'"
